...
it('adds an Artisan generators section to AGENTS.md with --agents', function () {
    ...
    $content = assertGenerated('AGENTS.md', [
        ...
        '`vendor/bin/partisan make:model Invoice --fields=number:string:unique,total:decimal(10,2)=0,is_paid:boolean=false,notes:text:nullable,user_id:foreignId --migration --factory --policy`',
        'the model, migration and factory are final',
